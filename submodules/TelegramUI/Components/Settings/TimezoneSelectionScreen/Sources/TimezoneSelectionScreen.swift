...
public class TimezoneSelectionScreen: ViewController {
    ...
    override public func loadDisplayNode() {
        self.displayNode = TimezoneSelectionScreenNode(context: self.context, presentationData: self.presentationData, navigationBar: self.navigationBar!, requestActivateSearch: { [weak self = self] in
            self?.activateSearch()
